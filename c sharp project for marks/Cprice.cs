...
namespace c_sharp_project_for_marks
{
    internal class Cprice
    {
        ...
        public double hargeisa = 60;
        public double mogadishu = 80;
        public double jabuuti = 70;
        public double rwanda = 120;
        public double south_africa = 500;
        public double nigeria = 460;
        public double india = 1200;
